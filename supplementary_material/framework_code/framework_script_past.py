...
class GP_STL():
    ...
    def __init__(self, data, signal_columns, processes, max_horizon, eval_wrapper, train_good_traces=[], seed_in=42, exploit_idempotence=True,
        ...
        if self.exploit_idempotence:
            ...
            globals()["FormulaTypeSurelyNoO"] = type("FormulaTypeSurelyNoO", (globals()["FormulaType"],),{})
            globals()["FormulaTypeSurelyNoOret"] = globals()["FormulaTypeSurelyNoO"]
            
            globals()["FormulaTypeSurelyNoH"] = type("FormulaTypeSurelyNoH", (globals()["FormulaType"],),{})
            globals()["FormulaTypeSurelyNoH.ret"] = globals()["FormulaTypeSurelyNoH"] 
            ...
            globals()["FormulaTypeSurelyNoOH"] = type("FormulaTypeSurelyNoOH", (globals()["FormulaTypeSurelyNoO"],globals()["FormulaTypeSurelyNoH"],),{})
            globals()["FormulaTypeSurelyNoOH.ret"] = globals()["FormulaTypeSurelyNoOH"] 
    
            globals()["FormulaTypeSurelyNoONot"] = type("FormulaTypeSurelyNoONot", (globals()["FormulaTypeSurelyNoO"],globals()["FormulaTypeSurelyNoNot"],),{})
            globals()["FormulaTypeSurelyNoONot.ret"] = globals()["FormulaTypeSurelyNoONot"] 
    
            globals()["FormulaTypeSurelyNoHNot"] = type("FormulaTypeSurelyNoHNot", (globals()["FormulaTypeSurelyNoH"],globals()["FormulaTypeSurelyNoNot"],),{})
            globals()["FormulaTypeSurelyNoHNot.ret"] = globals()["FormulaTypeSurelyNoHNot"] 
    
            globals()["FormulaTypeSurelyNoOHNot"] = type("FormulaTypeSurelyNoOHNot", (globals()["FormulaTypeSurelyNoO"],globals()["FormulaTypeSurelyNoH"],globals()["FormulaTypeSurelyNoNot"],),{})
            globals()["FormulaTypeSurelyNoOHNot.ret"] = globals()["FormulaTypeSurelyNoOHNot"] 
            ...
            def O_op(a: globals()["ModalLBoundEphemeral"], b: globals()["ModalRBoundEphemeral"], c: globals()["FormulaTypeSurelyNoO"]) -> globals()["FormulaTypeSurelyNoHNot"]: pass 
            def H_op(a: globals()["ModalLBoundEphemeral"], b: globals()["ModalRBoundEphemeral"], c: globals()["FormulaTypeSurelyNoH"]) -> globals()["FormulaTypeSurelyNoONot"]: pass     
            def S_op(a: globals()["ModalLBoundEphemeral"], b: globals()["ModalRBoundEphemeral"], c: globals()["FormulaType"], d: globals()["FormulaType"]) -> globals()["FormulaTypeSurelyNoOHNot"]: pass
                
            def Ounb_op(a: globals()["FormulaTypeSurelyNoO"]) -> globals()["FormulaTypeSurelyNoHNot"]: pass 
            def Hunb_op(a: globals()["FormulaTypeSurelyNoH"]) -> globals()["FormulaTypeSurelyNoONot"]: pass     
            def Sunb_op(a: globals()["FormulaType"], b: globals()["FormulaType"]) -> globals()["FormulaTypeSurelyNoOHNot"]: pass
            
            def not_op(a: globals()["FormulaTypeSurelyNoNot"]) -> globals()["FormulaTypeSurelyNoOH"]: pass
            def or_op(a: globals()["FormulaType"], b: globals()["FormulaType"]) -> globals()["FormulaTypeSurelyNoOHNot"]: pass
            def and_op(a: globals()["FormulaType"], b: globals()["FormulaType"]) -> globals()["FormulaTypeSurelyNoOHNot"]: pass
            def imp_op(a: globals()["FormulaType"], b: globals()["FormulaType"]) -> globals()["FormulaTypeSurelyNoOHNot"]: pass
    
    
            self.pset.addPrimitive(O_op, [globals()["ModalLBoundEphemeral"], globals()["ModalRBoundEphemeral"], globals()["FormulaTypeSurelyNoO"]], globals()["FormulaTypeSurelyNoHNot"])
            self.pset.addPrimitive(H_op, [globals()["ModalLBoundEphemeral"], globals()["ModalRBoundEphemeral"], globals()["FormulaTypeSurelyNoH"]], globals()["FormulaTypeSurelyNoONot"])
            self.pset.addPrimitive(S_op, [globals()["ModalLBoundEphemeral"], globals()["ModalRBoundEphemeral"], globals()["FormulaType"], globals()["FormulaType"]], globals()["FormulaTypeSurelyNoOHNot"])

            self.pset.addPrimitive(Ounb_op, [globals()["FormulaTypeSurelyNoO"]], globals()["FormulaTypeSurelyNoHNot"])
            self.pset.addPrimitive(Hunb_op, [globals()["FormulaTypeSurelyNoH"]], globals()["FormulaTypeSurelyNoONot"])
            self.pset.addPrimitive(Sunb_op, [globals()["FormulaType"], globals()["FormulaType"]], globals()["FormulaTypeSurelyNoOHNot"])

            
            self.pset.addPrimitive(not_op, [globals()["FormulaTypeSurelyNoNot"]], globals()["FormulaTypeSurelyNoOH"])
            self.pset.addPrimitive(or_op, [globals()["FormulaType"], globals()["FormulaType"]], globals()["FormulaTypeSurelyNoOHNot"])
            self.pset.addPrimitive(and_op, [globals()["FormulaType"], globals()["FormulaType"]], globals()["FormulaTypeSurelyNoOHNot"])
            self.pset.addPrimitive(imp_op, [globals()["FormulaType"], globals()["FormulaType"]], globals()["FormulaTypeSurelyNoOHNot"])

        else:

            assert False, "The exploitation of idempotence can only be disabled in the future bounded STL version"
    ...
    def get_stl_expr(formula_tree, window, scaler=None): ### if scaler != None => denormalize formula
        ...
        if type(formula_tree) == list  and  len(formula_tree) > 0: 
            ...
            if formula_tree[0] == 'O':
                ...
                return "once["+ str(int(formula_tree[1]*window)) + ":" + str(int(formula_tree[2]*window)) + "] (" + GP_STL.get_stl_expr(formula_tree[3], window, scaler) + ")"
            
            if formula_tree[0] == 'H':
                if len(formula_tree) != 4:
                    raise ValueError("Syntax error" + str(formula_tree))
                return "historically["+ str(int(formula_tree[1]*window)) + ":" + str(int(formula_tree[2]*window)) + "] (" + GP_STL.get_stl_expr(formula_tree[3], window, scaler) + ")"

            
            if formula_tree[0] == 'S':
                if len(formula_tree) != 5:
                    raise ValueError("Syntax error" + str(formula_tree))
                return "(" + GP_STL.get_stl_expr(formula_tree[3], window, scaler) + ") since["+ str(int(formula_tree[1]*window)) + ":" + str(int(formula_tree[2]*window)) + "] (" + GP_STL.get_stl_expr(formula_tree[4], window, scaler) + ")"

            if formula_tree[0] == 'Ounb':
                if len(formula_tree) != 2:
                    raise ValueError("Syntax error" + str(formula_tree))
                return "once (" + GP_STL.get_stl_expr(formula_tree[1], window, scaler) + ")"
            
            if formula_tree[0] == 'Hunb':
                if len(formula_tree) != 2:
                    raise ValueError("Syntax error" + str(formula_tree))
                return "historically (" + GP_STL.get_stl_expr(formula_tree[1], window, scaler) + ")"

            if formula_tree[0] == 'Sunb':
                if len(formula_tree) != 3:
                    raise ValueError("Syntax error" + str(formula_tree))
                return "(" + GP_STL.get_stl_expr(formula_tree[1], window, scaler) + ") since (" + GP_STL.get_stl_expr(formula_tree[2], window, scaler) + ")"
            ...
            if formula_tree[0] == 'ge': # base case ">=" for signal vs constant or signal comparison
                if len(formula_tree) != 3:
                    raise ValueError("Syntax error" + str(formula_tree))
                
                val = formula_tree[2]
                if(scaler!=None and not isinstance(val, str)):
...
#         print(traces_data[0])
        ...
        for i, tr in enumerate(traces_data):
            ...
            trace_data_pos.update({c: tr[c].iloc[0:pos_len].values.tolist() for c in GP_STL.signal_columns }) # inplace
        ...
        if len(good_wit) > 0:
            ...
            for trace in good_wit:
                ...
                try:
                    ...
                    rob=np.array(evaluate_spec(spec, trace_data))
                except Exception as e:
    ...
    def evalIndividual(i_individual, verbose=False):
        ...
        for i, trace_data in enumerate(traces_pos):
            try:
                rob=evaluate_spec(spec, trace_data)[-1]#[1]
            except Exception as e:
    ...
    def run_gp_stl(self, traces_data, max_gen=500, pop_size=100, cxpb=0.7, mutpb=0.5, verbose=False, alg_seed=42, train_good_traces=[],good_witnesses_ea=[],bad_witnesses_ea=[], maxfar=0., minacc=0.5, return_multiple_formulas_ea=False):
        ...
        with warnings.catch_warnings():
            ...
            if verbose:
                ...
                for p in pop:
                    print (self.ind_to_formula(p), 'height:', p.height, 'w:', p.window, self.t_len, p.bound_mult)#, 'h:', self.get_horizon(p) )
                    print('----------------------------------------------------')
            ...
            for g in tqdm(range(1, max_gen)):
                ...
                if (GP_STL.goodbad_traces_at_ea_generation > 0) and (g%GP_STL.goodbad_traces_at_ea_generation == 0):
                    ...
                    for ind, fit in zip(pop, fitnesses):
                        ...
                        assert np.nan_to_num(fit,0) >= 0 and np.nan_to_num(fit,0) <= 1
                        ind.fitness.values = (ind.fitness.values[0], ind.fitness.values[1], fit)#fit[6], fit[7]) # np.nan_to_num(fit[1],0)#, np.nan_to_num(fit[2],0)
                ...
                for mi,mutant in enumerate(offspring):
                    if random.random() < mutpb / g**(1/GP_STL.mutation_decay): ## N.B.:  0 <= random() < 1.0
                        ...
                        if GP_STL.feasible(mut) and mut.height <= GP_STL.max_height:
                            ...
                            mut.bound_mult = self.gen_mult(max_h)
            ...
            if GP_STL.goodbad_traces_at_ea_generation > 0:
                ...
                GP_STL.good_witnesses_ea = good_witnesses_ea_original if (len(good_witnesses_ea_original) > 0 and GP_STL.num_good_witnesses > 0) else []
                GP_STL.bad_witnesses_ea = bad_witnesses_ea_original if (len(bad_witnesses_ea_original) > 0 and GP_STL.num_bad_witnesses > 0) else []
...
def test_formula_offline_extended(arg):
    ...
    rob = np.nan_to_num(rob, posinf = -1, neginf = -1)
...
def evaluate_spec(spec, trace_data):
    ...
    robs = spec.evaluate(trace_data_temp)
    robs = np.asarray([r[1] for r in robs])
    finite_indexes = np.isfinite(robs)
    if np.sum(finite_indexes) > 0:
        if np.max(np.abs(robs[finite_indexes])) > 1.1:
            #assert False, "Robustness out of [-1,1] bounds."
            print("Robustness out of [-1,1] bounds", np.max(np.abs(robs[finite_indexes])))
        robs[finite_indexes] =  np.clip(robs[finite_indexes], -1, 1)
